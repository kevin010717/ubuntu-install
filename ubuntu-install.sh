...
#迁移到服务器
#换键盘布局
#ranger image-preview video-preview
...
(echo; echo 'eval "$(/home/linuxbrew/.linuxbre  w/bin/brew shellenv)"') >> /home/kevin/.zshrc            eval "$(/home/linuxbrew/.linuxbrew/bin/brew she  llenv)"
...
export OPENAI_API_KEY=sk-2Bka5JlIiffSMJIo28B0B75d77354eEe943d1c68C6010c7d
